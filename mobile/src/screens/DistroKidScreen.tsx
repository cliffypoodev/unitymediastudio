...
function DistroKidScreenWeb() {
  ...
  const handleGoBack = () => {
    const iframe = document.getElementById("distrokid-iframe") as HTMLIFrameElement;
      ...
      <View style={{ flex: 1, backgroundColor: TWILIGHT.void, paddingTop: insets.top }}>
        {isLoading && (
          <View
            ...
            style={{ top: insets.top, backgroundColor: TWILIGHT.cyan }}
          >
            <LinearGradient
              colors={[TWILIGHT.cyan, TWILIGHT.teal]}
          ...
          extraButtons={[
            {
              ...
              onPress: () => window.open("https://distrokid.com", "_blank"),
              label: "Open DistroKid in New Tab"
            }
          ]}
        />
      </View>
...
function DistroKidScreenNative() {
      ...
      <View style={{ flex: 1, backgroundColor: TWILIGHT.void, paddingTop: insets.top }}>
        ...
        <WebView
          ...
          renderLoading={() => (
            ...
            >
              <ActivityIndicator size="large" color={TWILIGHT.cyan} />
        ...
        <SlimNavBar
          ...
          extraButtons={[
            {
              icon: "cloud-upload-outline",
              onPress: () => Linking.openURL("distrokid://").catch(() => console.log("Could not open DistroKid app")),
              label: "Open DistroKid App"
            }
          ]}
        />
      </View>
...
export function DistroKidScreen() {
  if (isWeb) {
    return <DistroKidScreenWeb />;
  }
  return <DistroKidScreenNative />;
}
