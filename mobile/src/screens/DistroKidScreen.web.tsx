...
export function DistroKidScreen() {
  ...
  React.useEffect(() => {
    // Open DistroKid in a new tab when component mounts
    ...
    <GestureHandlerRootView style={{ flex: 1 }}>
      <View style={{ flex: 1, backgroundColor: TWILIGHT.void, paddingTop: insets.top, justifyContent: "center", alignItems: "center", padding: 20 }}>
        <View style={{ backgroundColor: TWILIGHT.dark, borderRadius: 16, padding: 32, alignItems: "center", maxWidth: 400 }}>
          <View style={{ width: 80, height: 80, borderRadius: 40, backgroundColor: TWILIGHT.cyan, justifyContent: "center", alignItems: "center", marginBottom: 20 }}>
          ...
          <Text style={{ fontSize: 16, color: TWILIGHT.wolf, textAlign: "center", marginBottom: 24 }}>
            DistroKid has been opened in a new browser tab. This is required because DistroKid cannot be embedded directly in the app for security reasons.
          </Text>
          ...
          <View style={{ borderTopWidth: 1, borderTopColor: TWILIGHT.shadow, paddingTop: 20, width: "100%" }}>
            <Pressable
              ...
              style={{ backgroundColor: TWILIGHT.cyan, borderRadius: 12, padding: 16, alignItems: "center" }}
            >
              <Text style={{ color: TWILIGHT.void, fontSize: 16, fontWeight: "bold" }}>
                Open DistroKid Again
              </Text>
            </Pressable>
          </View>
        </View>
